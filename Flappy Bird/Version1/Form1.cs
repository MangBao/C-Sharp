...
namespace Version1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                chim.Location = new Point(400, 700);
                this.Refresh();
                timer1.Enabled = true;
                timer2.Enabled = true;
            }
        ...
        private void timer2_Tick(object sender, EventArgs e, KeyEventArgs i)//Tinmer của con chim
        {
            ...
            else
            {
                timer2.Stop();
                timer1.Stop();
                MessageBox.Show("\tGame Over !\n Your Score: " + diem + "\n" + "Press Enter để thoát");
                
        }

        private void timer1_Tick(object sender, EventArgs e)//Timer của ống
        {
            // DoubleBuffer => hiệu chỉnh không bị giựt màn hình.
            this.SetStyle(ControlStyles.AllPaintingInWmPaint | ControlStyles.UserPaint | ControlStyles.DoubleBuffer, true);
            x_cap1 -= 10;
        ...
        {           
            ...
            ongduoi1.Location = new Point(x_cap1, y_ongduoi1);
            //===============================================
            x_cap2 = x_cap1 + ongtren1.Width + 500; //Mỗi ống cách nhau 300
            ...
            lbldiem.Location = new Point(0, this.Height - 50);// Set vị trí label điểm
            timer1.Interval = 1;
            timer2.Interval = 50;
        }
    }
